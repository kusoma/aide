...
app.get('/canvas', (req, res) => {
	const token = '2948~9xKAB9OaqKDraVLBrqO0b3KiIpdq3aKW3cdp3IaoC2U6kcRo9bIjeiLeRSNEfnz0';
...
mongoose
	.connect(`mongodb://${process.env.MONGO_USERNAME}:${process.env.MONGO_PASSWORD}@${process.env.MONGO_HOSTNAME}:${process.env.MONGO_PORT}/${process.env.MONGO_DB}?authSource=admin`, { useNewUrlParser: true, useUnifiedTopology: true })
	.then(() => {
		app.listen(3000);
