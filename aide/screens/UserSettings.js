	...
	render () {
		return (
			<ScrollView contentContainerStyle={GlobalStyle.container}>
				...
				<View>
					<TextField image='user' style={GlobalStyle.formIcon} placeholder='First Name' onChangeText={firstName => this.setState({ firstName })} value={this.state.firstName} editable={true} />
					<TextField image='user' style={GlobalStyle.formIcon} placeholder='Last Name' onChangeText={lastName => this.setState({ lastName })} value={this.state.lastName} editable={true} />
				...
				<View style={{ margin: 16 }}>
					...
					<WideButton label='Connect Canvas' image='google' imageColor='#000' onPress={() => this.props.navigation.navigate('ConnectCanvas')} />
				</View>
