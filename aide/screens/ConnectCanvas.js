      ...
      <ScrollView contentContainerStyle={GlobalStyle.container}>
        ...
        <View>
          <TextField
            ...
            placeholder="Get Token Below and Paste Here"
            onChangeText={canvasToken => this.setState({ canvasToken })}
            value={this.state.canvasToken}
            editable={true}
          />
        </View>
        ...
        <View>
          <WideButton
            ...
            image="share"
            imageColor="#fff"
            onPress={ ()=>{ Linking.openURL('https://canvas.apu.edu/profile/settings')}}
          />
        </View>
      </ScrollView>
