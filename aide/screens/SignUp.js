    ...
    callGraphql(request, json => {
      ...
      if (json.errors) {
        ...
        let user = {
          ...
          defaultStudyLength: json.data.createUser.defaultStudyLength,
          defaultBreakLength: json.data.createUser.defaultBreakLength,
          defaultTechnique: json.data.createUser.defaultTechnique
        };
  ...
  render() {
    return (
      <ScrollView contentContainerStyle={GlobalStyle.container}>
        ...
        <TouchableOpacity
          style={[GlobalStyle.pillButton, { width: Constant.MAX_WIDTH / 1.5 }]}
